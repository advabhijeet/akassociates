...
- Confirmed public HTML script references now use `script.js?v=citadel-live-12`.
- Live visual check remains manual/Codex-dependent after GitHub Pages refresh.
...
- Bumped public stylesheet references to `style.css?v=theme-package-5` and script references to `script.js?v=citadel-live-12`.

Validation / notes:

- Ran `node --check assets/js/script.js`.
- Ran `git diff --check`; only Windows line-ending warnings were reported.
- Confirmed no functional `style.css?v=theme-package-2`, `script.js?v=citadel-live-12` or old dark navbar logo cache references remain.
