...
Superseded planning documents have been moved to:

```text
docs/archive/superseded-maintenance/
```

Archived docs are preserved for historical reference only. Do not use archived docs as current operating instructions unless a newer active doc expressly points to them.
