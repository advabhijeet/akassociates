/* Citadel of Kang Theme Pack: Article Index Module
   ...
   - <article data-citadel-article-index> explicitly enables the module.
   - Fallback: first article.article-body or article.ck-article with at least 3 direct h2 headings.
*/
(function () {
  ...
  var getTopOffset = function () {
    var raw = window.getComputedStyle(document.documentElement).getPropertyValue('--ck-nav-space') || '108px';
